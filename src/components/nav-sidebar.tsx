  ...
  return (
    <aside className="flex w-60 shrink-0 flex-col bg-[#0e0e0e] border-r border-[#262626]">
      ...
      <div className="flex items-center gap-3 px-5 py-6">
        <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-[#ff6b1a]">
        ...
        <div>
          ...
          <div className="text-[11px] font-semibold text-[#ff6b1a] tracking-wider uppercase mt-0.5">
            CollectIQ
          </div>
        </div>
      </div>
      ...
      <nav aria-label="Main navigation" className="flex flex-1 flex-col gap-0.5 px-3 mt-2">
        ...
        {NAV_ITEMS.map((item) => {
          ...
          return (
            ...
            >
              <item.icon className={cn("h-4 w-4 shrink-0", isActive && "text-[#ff6b1a]")} />
              {item.label}
            </Link>
          );
        })}
      ...
      <div className="border-t border-[#262626] px-5 py-4">
        <div className="flex items-center gap-2">
          <div className="h-1.5 w-1.5 rounded-full bg-[#ff6b1a] animate-pulse" />
